...
<template>
                                    ...
                                    <table class="table-auto w-full text-left whitespace-no-wrap">
                                        ...
                                        <tbody>
                                            <tr v-for="customer in customers.value.data" :key="customer.id">
                                                ...
                                                <td class="border-b-2 border-gray-200 px-4 py-3"><button @click="setCustomer({ id: customer.id, kana: customer.kana})" type="button" class="text-blue-400">{{ customer.id }}</button></td>
  ...
  <button @click="searchCustomers" type="button" class="flex mx-auto text-white bg-teal-500 border-0 py-2 px-8 focus:outline-none hover:bg-teal-600 rounded text-lg">検索する</button>
</template>
